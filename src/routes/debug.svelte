<script lang="ts">
      ...
      children: [
        {
          ...
          onClick: () => {
            console.log("Custom click handler for Level 2A");
  ...
  function navigateToDocumentation() {
    ...
    console.log("Children:", docItem.children);
          ...
          originalChart["currentSeries"] = [
            {
              ...
              data: [
                ...
                ...currentSeries[0].data.filter(
                  (p: any) =>
                    p.axis !== "More Documentation" &&
